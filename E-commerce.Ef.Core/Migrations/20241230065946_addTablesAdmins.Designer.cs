...
namespace E_commerce.Ef.Core.Migrations
{
    ...
    [Migration("20241230065946_addTablesAdmins")]
    partial class addTablesAdmins
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commrece.Domain.Admin.CustomerPageSetting", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("IsDeleteDialogActive")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsLoderActive")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsPageActive")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsTosterActive")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Customer-Page-setting", (string)null);
                });

            modelBuilder.Entity("E_Commrece.Domain.Admin.SupplierPageSetting", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Supplier-Page-setting", (string)null);
                });
            ...
            modelBuilder.Entity("E_commerce.Ef.Core.Product.Inventory", b =>
                {
                    b.HasOne("E_commerce.Ef.Core.Product.Products", "products")
                        .WithOne("Inventorys")
                        .HasForeignKey("E_commerce.Ef.Core.Product.Inventory", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
